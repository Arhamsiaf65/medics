 ...
 */
const generateSlotsFromBlock = (blockStart, blockEnd, durationMinutes) => {
    const slots = [];
 ...
 */
const getDoctorAllSlots = (doctor, date) => {
    const dayOfWeek = getDayName(date);
    const workingHoursObj = doctor.workingHours;
...
export const doctorUpdateStatus = async (req, res) => {
    try {
